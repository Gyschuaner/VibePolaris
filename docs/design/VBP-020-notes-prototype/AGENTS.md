...
- Annotation chrome: replace “我的想法” with the note icon, moved from the original text gutter. Hide routine save/status labels in annotation footers. Show local 24-hour HH:mm; hovering or focusing the time reveals the full year/month/day immediately to its left. Keep exceptional save-failure recovery; examples remain identified in My Notes and the icon tooltip.
